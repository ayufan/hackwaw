...
import (
	...
	"gitlab.com/hackwaw-disrupt/golang-proxy-server/Godeps/_workspace/src/github.com/coreos/pkg/flagutil"
	"gitlab.com/hackwaw-disrupt/golang-proxy-server/Godeps/_workspace/src/github.com/dghubble/sling"
	"golang.org/x/oauth2"
)
